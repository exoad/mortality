...
final class UserProfileDefaults {
  ...
  static const bool defaultUseGenderBasedCalculations = true;
...
final class UserProfile implements Versioned {
  ...
  @JsonKey(
      required: true,
      defaultValue:
          UserProfileDefaults.defaultUseGenderBasedCalculations)
  final bool defaultUseGenderBasedCalculations;
  ...
  UserProfile(
      {required this.name,
      required this.sex,
      required this.defaultUseGenderBasedCalculations,
